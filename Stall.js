...
export class Stall extends BaseObject {
    constructor(element, id, point, width, height, direction, isOpen) {
        ...
        if (this.direction === DIRECTION_RIGHT) {
            let wall = new Wall(this.container, 'wall-1-' + id, this.location.addXYAndClone(this.width, 0), 20, wallHeight);
            let wall2 = new Wall(this.container, 'wall-2-' + id, this.location.addXYAndClone(this.width, wallHeight + 140), 20, wallHeight);
            ...
            let wall = new Wall(this.container, 'wall-1-' + id, this.location.addXYAndClone(-5, 0), 20, wallHeight);
            let wall2 = new Wall(this.container, 'wall-2-' + id, this.location.addXYAndClone(-5, wallHeight + 140), 20, wallHeight);
            this.walls = [wall, wall2];
